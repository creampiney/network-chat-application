...
export const login = async (req: Request, res: Response) => {
  ...
  if (!user) {
    return res
      .status(400)
      .send(generateStatusResponse(400, "Username or password is wrong"));
  }
...
export const register = async (req: Request, res: Response) => {
  ...
  if (findUser) {
    return res
      .status(400)
      .send(generateStatusResponse(400, "This username is already used"));
  }
...
export const getUser = async (req: Request, res: Response) => {
  ...
  if (!query) {
    return res
      .status(400)
      .clearCookie("auth")
      .send(generateStatusResponse(400, "Not Found"));
  }
