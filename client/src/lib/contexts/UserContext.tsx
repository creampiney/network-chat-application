...
export const UserContext = createContext<{currentUser : User | null ,fetchUser : () => Promise<boolean>, isLoading: boolean,fetchUserNoRedirect : () => Promise<boolean>}>({currentUser : null , fetchUser : async () => {return false;}, isLoading: true,fetchUserNoRedirect : async () => {return false;}});
